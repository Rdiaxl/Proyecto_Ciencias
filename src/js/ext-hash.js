const ExtHash = (() => {
  ...
  function setMethod(method) {
    ...
    // Actualizar estilos visuales de las pestañas (escopeado a esta pantalla)
    document.querySelectorAll('#extHashTabs .hash-tab').forEach(tab => {
      tab.classList.remove('active');
    });
    const activeTab = document.getElementById(`ebtn-${method}`);
  ...
  function generate() {
    ...
    document.getElementById('extHashStatus').textContent = `Disco preparado: ${M} cubetas de capacidad ${B}. Método: ${currentMethod.toUpperCase()}`;
