const LABELS = {
  ...
  hashmaps: 'Hashmaps',
  'Transformacion de Claves': 'Transformación de Claves',
  arbol: 'Árbol de Búsquedas',
  'busqueda-digital': 'Búsqueda Digital',
  'busqueda-residuos': 'Búsqueda por Residuos',
  'busqueda-residuos-multiples': 'Residuos Múltiples',
  'arbol-huffman': 'Árbol de Huffman',
  'ext-secuencial': 'Secuencial Externa', 
  'ext-binaria': 'Binaria Externa', 
  'ext-hash': 'Transformación de Claves Externa', 
  'ext-hash-dinamico': 'Búsquedas Dinámicas'
};
...
const PARENTS = {
  ...
  binaria: 'internas', 
  hashmaps: 'internas',
  'Transformacion de Claves': 'internas',
  arbol: 'internas',
  'busqueda-digital': 'arbol',
  'busqueda-residuos': 'arbol',
  'busqueda-residuos-multiples': 'arbol',
  'arbol-huffman': 'arbol',
